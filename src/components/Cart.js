                ...
                <div style={{
                  ...
                  <img 
                    src={`https://images.unsplash.com/photo-${
                      item.camera.id === 3 ? '1585060544812-6b45742d762f' :
                      item.processor.id === 1 ? '1592899677977-9c10ca588bbd' :
                      item.display.id === 2 ? '1616348436168-de43ad0db179' :
                      item.ram.id === 3 ? '1610945415295-d9bbf067e59c' :
                      item.rom.id === 3 ? '1574944985070-8f3ebc6b79d2' :
